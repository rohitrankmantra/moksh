      ...
      <main>
        ...
        <div className="fixed bottom-6 left-6 z-50 flex flex-col gap-4">
          <a 
            ...
            className="w-12 h-12 bg-[#25D366] text-white flex items-center justify-center border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all"
            title="WhatsApp Us"
          >
          ...
          <a 
            ...
            className="w-12 h-12 bg-[#4A6FA5] text-white flex items-center justify-center border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all"
            title="Call Us"
          >
