              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <div>
                    ...
                    <a href="tel:+919876543210" className="text-base font-bold hover:underline">+91 98765 43210</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <form className="space-y-4">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" className="w-full bg-white border-2 border-gray-300 px-4 py-3 text-sm focus:outline-none focus:border-black transition-colors font-bold" />
                </div>
                <div>
              ...
              <div>
                ...
                <input type="email" className="w-full bg-white border-2 border-gray-300 px-4 py-3 text-sm focus:outline-none focus:border-black transition-colors font-bold" />
              </div>
              <div>
                <label className="block text-xs font-bold text-black uppercase tracking-wider mb-2">How can we help?</label>
                <textarea rows={4} className="w-full bg-white border-2 border-gray-300 px-4 py-3 text-sm focus:outline-none focus:border-black transition-colors font-bold resize-none"></textarea>
              </div>
