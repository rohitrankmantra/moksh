...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b-2 border-black flex justify-between items-center py-3 px-6 md:px-12 transition-transform duration-300">
      <div className="relative w-40 h-14 md:w-48 md:h-16">
        <Image src="/logo.jpg" alt="Moksh Communication" fill className="object-contain object-left" priority />
      </div>
      <div className="hidden md:flex items-center gap-8 text-sm font-bold text-black uppercase tracking-wide">
        ...
        <a href="#process" className="hover:text-[#C1272D] transition-colors relative group">
          Process
          <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#C1272D] transition-all group-hover:w-full"></span>
        </a>
