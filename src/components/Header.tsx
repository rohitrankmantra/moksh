...
export default function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b-2 border-black flex justify-between items-center py-2 px-6 md:px-12 transition-transform duration-300">
      <a href="https://www.mokshadagency.com" className="relative w-44 h-16 md:w-56 md:h-20">
